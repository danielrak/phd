...
for (j in hsupp) {
  ...
  for (i in agedepvars_c[
    ...
    assign(paste("agefrd_pcs_g2_p1_", i, "_tous_rdch", j, sep = ""),
    ...
    assign(paste("agefrd_pcsR_p2_", i, "_tous_rdch", j, sep = ""),
           ivreg(as.formula(paste(i, " ~ ", 
                                  c("age_abs", 
                                    "dist", "old : dist",
                                    "I(dist ^ 2)", 
...
save(list = ls()[str_detect(ls(), "agefrd") & 
     ...
     file = here("agefrd_hsupp_def2", "agefrd_pcs_g2_hsupp.rda"),
     version = 2)