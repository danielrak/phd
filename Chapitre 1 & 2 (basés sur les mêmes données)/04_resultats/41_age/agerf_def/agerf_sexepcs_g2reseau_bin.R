# agerf_sexepcs_g2reseau_bin (def). 
  ...
  for (i in agedepvars_c) {
    assign(paste("agerf_",
                 ...
                 j %>% str_extract(".*_AND_") %>% 
                   str_remove("_AND_"),
                 "_pcs_g2_",
                 j %>% str_extract("_AND_.*_AND2_") %>% 
                   str_remove("_AND_") %>% 
                   str_remove("_AND2_"),
                 "_reseau_bin_",
                 j %>% str_extract("_AND2_.*") %>% 
                   str_remove("_AND2_"),
                 "_c",
                 sep = ""),
...
dir.create(here("agerf_def", "agerf_sexepcs_g2reseau_bin"))
