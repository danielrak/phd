# ageivmtrel0_excl_bim_sexe_mod (def2). 
...
for (i in agedepvars_cdi %>% 
  ...
  assign(paste("ageivmtrel0_excl_bim_sexe_mod_", 
               i, 
               "_tous_d",
               sep = ""),
         ivreg(as.formula(paste(
           ...
           c("age_absdnb", "sexe_mod", "pcs_reg_mod", 
             ...
             "I(bim_dnb_2 - p_bim_dnb_2) : sexe_mod",
             "I(bim_dnb_3 - p_bim_dnb_3) : sexe_mod",
             "I(bim_dnb_4 - p_bim_dnb_4) : sexe_mod",
             "I(bim_dnb_5 - p_bim_dnb_5) : sexe_mod"
             
             
             ) %>% 
             paste(collapse = " + "),
           "|. - age_absdnb + bim_dnb_1", 
           "- age_absdnb : sexe_mod + bim_dnb_1 : sexe_mod",
           "- I(age_absdnb - p_age_absdnb) + I(bim_dnb_1 - p_bim_dnb_1)",
           "- I(age_absdnb - p_age_absdnb) : sexe_mod + I(bim_dnb_1 - p_bim_dnb_1) : sexe_mod",
           sep = ""
         )),
         data = d))
}
...
save(list = ls()[str_detect(ls(), "ageiv") & 
                   ! str_detect(ls(), "^ageiv")],
     file = here("ageivmtrel0_excl_def2", "ageivmtrel0_excl_bim_sexe_mod.rda"),
     version = 2)
