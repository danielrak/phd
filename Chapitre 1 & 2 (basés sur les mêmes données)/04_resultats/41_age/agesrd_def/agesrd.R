...
for (i in agedepvars_c) {
  ...
  assign(paste("agesrd_p1_", i, "_tous_rdch30", sep = ""),
  ...
  assign(paste("agesrd_p2_", i, "_tous_rdch30", sep = ""),
         lm(as.formula(paste(i, " ~ ", 
                                c("old", 
                                  "dist", "old : dist",
                                  "I(dist ^ 2)", 
...
for (i in agedepvars_cdi) {
  ...
  assign(paste("agesrd_p1_", i, "_tous_rdcdih30", sep = ""),
         lm(as.formula(paste(i, " ~ ", 
                                c("old", 
                                  "dist", "old : dist",
                                  "sexe", "pcsR") %>%
  ...
  assign(paste("agesrd_p2_", i, "_tous_rdcdih30", sep = ""),
         lm(as.formula(paste(i, " ~ ", 
                                c("old", 
                                  "dist", "old : dist",
                                  "I(dist ^ 2)", 
...
dir.create(here("agesrd_def", "agesrd"))
