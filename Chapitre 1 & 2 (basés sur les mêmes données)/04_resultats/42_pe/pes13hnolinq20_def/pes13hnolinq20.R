...
for (i in ls()[str_detect(ls(), "^pes13hnolinq20")]) {
...
save(list = ls()[str_detect(ls(), "pes13hnolinq20") & 
                  ! str_detect(ls(), "^pes13hnolinq20")],
     file = here("pes13hnolinq20_def", "pes13hnolinq20.rda"),
     version = 2)
