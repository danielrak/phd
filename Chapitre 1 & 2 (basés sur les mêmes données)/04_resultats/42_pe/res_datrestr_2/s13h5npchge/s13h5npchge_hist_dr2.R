# s13h5npchge_o1_hist_dr2, moy_hist_ec. 
...
s13h5npchge_sA_hist_dr2 <- plm(moy_hist_ec ~ 
...
s13h5npchge_sB_hist_dr2 <- update(s13h5npchge_sA_hist_dr2, . ~ . 
...
s13h5npchge_sC_hist_dr2 <- update(s13h5npchge_sB_hist_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5npchge_sD_hist_dr2 <- update(s13h5npchge_sC_hist_dr2, . ~ . 
...
s13h5npchge_sE_hist_dr2 <- update(s13h5npchge_sD_hist_dr2, . ~ . 
...
s13h5npchge_sF_hist_dr2 <- update(s13h5npchge_sC_hist_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_2", "s13h5npchge", 
                 "s13h5npchge_hist_dr2.rda"), version = 2)