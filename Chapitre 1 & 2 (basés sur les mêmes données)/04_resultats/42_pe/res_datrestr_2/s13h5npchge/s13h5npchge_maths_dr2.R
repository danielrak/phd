# s13h5npchge_o1_maths_dr2, moy_maths_ec. 
...
s13h5npchge_sA_maths_dr2 <- plm(moy_maths_ec ~ 
...
s13h5npchge_sB_maths_dr2 <- update(s13h5npchge_sA_maths_dr2, . ~ . 
...
s13h5npchge_sC_maths_dr2 <- update(s13h5npchge_sB_maths_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5npchge_sD_maths_dr2 <- update(s13h5npchge_sC_maths_dr2, . ~ . 
...
s13h5npchge_sE_maths_dr2 <- update(s13h5npchge_sD_maths_dr2, . ~ . 
...
s13h5npchge_sF_maths_dr2 <- update(s13h5npchge_sC_maths_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_2", "s13h5npchge", 
                 "s13h5npchge_maths_dr2.rda"), version = 2)