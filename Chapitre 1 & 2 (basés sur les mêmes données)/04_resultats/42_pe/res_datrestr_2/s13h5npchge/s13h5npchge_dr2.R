...
s13h5npchge_sA_dr2 <- plm(moy_ec1 ~ 
...
s13h5npchge_sB_dr2 <- update(s13h5npchge_sA_dr2, . ~ . 
...
s13h5npchge_sC_dr2 <- update(s13h5npchge_sB_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5npchge_sD_dr2 <- update(s13h5npchge_sC_dr2, . ~ . 
...
s13h5npchge_sE_dr2 <- update(s13h5npchge_sD_dr2, . ~ . 
...
s13h5npchge_sF_dr2 <- update(s13h5npchge_sC_dr2, . ~ . 
