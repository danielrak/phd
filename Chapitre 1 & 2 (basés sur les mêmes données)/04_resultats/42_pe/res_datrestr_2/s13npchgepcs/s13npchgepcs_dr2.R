...
for (i in c("Defav", "Moy", "Fav", "Tresfav", "Autres")) {
  assign(paste("s13npchge_sA_o1_", i, "_dr2", sep = ""),
...
for (i in c("Defav", "Moy", "Fav", "Tresfav", "Autres")) {
  assign(paste("s13npchge_sB_o1_", i, "_dr2", sep = ""),
...
for (i in c("Defav", "Moy", "Fav", "Tresfav", "Autres")) {
  assign(paste("s13npchge_sC_o1_", i, "_dr2", sep = ""),
...
for (i in c("Defav", "Moy", "Fav", "Tresfav", "Autres")) {
  assign(paste("s13npchge_sF_o1_", i, "_dr2", sep = ""),
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_2", "s13npchgepcs", 
                 "s13npchgepcs_o1_dr2.rda"), version = 2)
