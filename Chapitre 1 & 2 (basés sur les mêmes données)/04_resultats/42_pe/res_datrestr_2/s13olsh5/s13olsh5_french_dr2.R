...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_2", "s13olsh5", 
                 "s13olsh5_french_dr2.rda"), version = 2)