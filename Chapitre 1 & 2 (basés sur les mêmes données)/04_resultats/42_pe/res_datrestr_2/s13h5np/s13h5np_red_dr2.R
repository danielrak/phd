...
s13h5np_sA_red_dr2 <- plm(moy_red_ec ~ 
...
s13h5np_sB_red_dr2 <- update(s13h5np_sA_red_dr2, . ~ . 
...
s13h5np_sC_red_dr2 <- update(s13h5np_sB_red_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_red_dr2 <- update(s13h5np_sC_red_dr2, . ~ . 
...
s13h5np_sE_red_dr2 <- update(s13h5np_sD_red_dr2, . ~ . 
...
s13h5np_sF_red_dr2 <- update(s13h5np_sC_red_dr2, . ~ . 
