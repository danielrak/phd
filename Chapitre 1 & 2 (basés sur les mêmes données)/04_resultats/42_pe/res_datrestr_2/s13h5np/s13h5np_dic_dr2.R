...
s13h5np_sA_dic_dr2 <- plm(moy_dic_ec ~ 
...
s13h5np_sB_dic_dr2 <- update(s13h5np_sA_dic_dr2, . ~ . 
...
s13h5np_sC_dic_dr2 <- update(s13h5np_sB_dic_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_dic_dr2 <- update(s13h5np_sC_dic_dr2, . ~ . 
...
s13h5np_sE_dic_dr2 <- update(s13h5np_sD_dic_dr2, . ~ . 
...
s13h5np_sF_dic_dr2 <- update(s13h5np_sC_dic_dr2, . ~ . 
