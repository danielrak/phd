...
s13h5np_sB_dr2 <- update(s13h5np_sA_dr2, . ~ . 
...
s13h5np_sC_dr2 <- update(s13h5np_sB_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_dr2 <- update(s13h5np_sC_dr2, . ~ . 
...
s13h5np_sE_dr2 <- update(s13h5np_sD_dr2, . ~ . 
...
s13h5np_sF_dr2 <- update(s13h5np_sC_dr2, . ~ . 
