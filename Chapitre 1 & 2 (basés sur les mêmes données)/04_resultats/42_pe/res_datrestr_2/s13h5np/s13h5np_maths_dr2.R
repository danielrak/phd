# s13h5np_o1_maths_dr2, moy_maths_ec. 
...
s13h5np_sA_maths_dr2 <- plm(moy_maths_ec ~ 
...
s13h5np_sB_maths_dr2 <- update(s13h5np_sA_maths_dr2, . ~ . 
...
s13h5np_sC_maths_dr2 <- update(s13h5np_sB_maths_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_maths_dr2 <- update(s13h5np_sC_maths_dr2, . ~ . 
...
s13h5np_sE_maths_dr2 <- update(s13h5np_sD_maths_dr2, . ~ . 
...
s13h5np_sF_maths_dr2 <- update(s13h5np_sC_maths_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_2", "s13h5np", 
                 "s13h5np_maths_dr2.rda"), version = 2)