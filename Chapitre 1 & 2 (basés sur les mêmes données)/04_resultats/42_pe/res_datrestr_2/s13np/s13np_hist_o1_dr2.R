...
s13np_sA_hist_o1_dr2 <- plm(moy_hist_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_2, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13np_sB_hist_o1_dr2 <- update(s13np_sA_hist_o1_dr2, . ~ . 
...
s13np_sC_hist_o1_dr2 <- update(s13np_sB_hist_o1_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13np_sD_hist_o1_dr2 <- update(s13np_sC_hist_o1_dr2, . ~ . 
...
s13np_sE_hist_o1_dr2 <- update(s13np_sD_hist_o1_dr2, . ~ . 
...
s13np_sF_hist_o1_dr2 <- update(s13np_sC_hist_o1_dr2, . ~ . 
