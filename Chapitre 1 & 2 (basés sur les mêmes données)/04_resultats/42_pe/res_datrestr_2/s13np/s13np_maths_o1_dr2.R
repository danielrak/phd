...
s13np_sA_maths_o1_dr2 <- plm(moy_maths_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_2, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13np_sB_maths_o1_dr2 <- update(s13np_sA_maths_o1_dr2, . ~ . 
...
s13np_sC_maths_o1_dr2 <- update(s13np_sB_maths_o1_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13np_sD_maths_o1_dr2 <- update(s13np_sC_maths_o1_dr2, . ~ . 
...
s13np_sE_maths_o1_dr2 <- update(s13np_sD_maths_o1_dr2, . ~ . 
...
s13np_sF_maths_o1_dr2 <- update(s13np_sC_maths_o1_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_2", "s13np", 
                 "s13_maths_o1_dr2.rda"), version = 2)