...
s13np_sC_o1_dr2 <- update(s13np_sB_o1_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13np_sD_o1_dr2 <- update(s13np_sC_o1_dr2, . ~ . 
...
s13np_sE_o1_dr2 <- update(s13np_sD_o1_dr2, . ~ . 
...
s13np_sF_o1_dr2 <- update(s13np_sC_o1_dr2, . ~ . 
