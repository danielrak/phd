...
s13hnolinq5np_sA_french_dr2 <- plm(moy_fran_ec ~ 
...
s13hnolinq5np_sB_french_dr2 <- update(s13hnolinq5np_sA_french_dr2, . ~ . 
...
s13hnolinq5np_sC_french_dr2 <- update(s13hnolinq5np_sB_french_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5np_sD_french_dr2 <- update(s13hnolinq5np_sC_french_dr2, . ~ . 
...
s13hnolinq5np_sE_french_dr2 <- update(s13hnolinq5np_sD_french_dr2, . ~ . 
...
s13hnolinq5np_sF_french_dr2 <- update(s13hnolinq5np_sC_french_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_2", "s13hnolinq5np",
                 "s13hnolinq5np_french_dr2.rda"), version = 2)