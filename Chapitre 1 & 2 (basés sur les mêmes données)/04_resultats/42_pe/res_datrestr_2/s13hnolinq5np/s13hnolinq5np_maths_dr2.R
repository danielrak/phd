# s13hnolinq5np, dr2, moy_maths_ec
...
s13hnolinq5np_sA_maths_dr2 <- plm(moy_maths_ec ~ 
...
s13hnolinq5np_sB_maths_dr2 <- update(s13hnolinq5np_sA_maths_dr2, . ~ . 
...
s13hnolinq5np_sC_maths_dr2 <- update(s13hnolinq5np_sB_maths_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5np_sD_maths_dr2 <- update(s13hnolinq5np_sC_maths_dr2, . ~ . 
...
s13hnolinq5np_sE_maths_dr2 <- update(s13hnolinq5np_sD_maths_dr2, . ~ . 
...
s13hnolinq5np_sF_maths_dr2 <- update(s13hnolinq5np_sC_maths_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_2", "s13hnolinq5np",
                 "s13hnolinq5np_maths_dr2.rda"), version = 2)