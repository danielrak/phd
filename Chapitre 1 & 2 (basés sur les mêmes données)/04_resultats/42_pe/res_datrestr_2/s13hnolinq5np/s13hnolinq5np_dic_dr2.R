...
s13hnolinq5np_sA_dic_dr2 <- plm(moy_dic_ec ~ 
...
s13hnolinq5np_sB_dic_dr2 <- update(s13hnolinq5np_sA_dic_dr2, . ~ . 
...
s13hnolinq5np_sC_dic_dr2 <- update(s13hnolinq5np_sB_dic_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5np_sD_dic_dr2 <- update(s13hnolinq5np_sC_dic_dr2, . ~ . 
...
s13hnolinq5np_sE_dic_dr2 <- update(s13hnolinq5np_sD_dic_dr2, . ~ . 
...
s13hnolinq5np_sF_dic_dr2 <- update(s13hnolinq5np_sC_dic_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_2", "s13hnolinq5np",
                 "s13hnolinq5np_dic_dr2.rda"), version = 2)