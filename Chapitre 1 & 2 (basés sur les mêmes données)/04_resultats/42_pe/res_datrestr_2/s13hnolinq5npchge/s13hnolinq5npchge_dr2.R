...
s13hnolinq5npchge_sA_dr2 <- plm(moy_ec1 ~ 
...
s13hnolinq5npchge_sB_dr2 <- update(s13hnolinq5npchge_sA_dr2, . ~ . 
...
s13hnolinq5npchge_sC_dr2 <- update(s13hnolinq5npchge_sB_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_dr2 <- update(s13hnolinq5npchge_sC_dr2, . ~ . 
...
s13hnolinq5npchge_sE_dr2 <- update(s13hnolinq5npchge_sD_dr2, . ~ . 
...
s13hnolinq5npchge_sF_dr2 <- update(s13hnolinq5npchge_sC_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_2", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_dr2.rda"), version = 2)