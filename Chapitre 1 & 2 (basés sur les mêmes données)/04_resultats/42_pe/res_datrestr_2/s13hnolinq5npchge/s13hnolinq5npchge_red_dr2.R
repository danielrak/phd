...
s13hnolinq5npchge_sA_red_dr2 <- plm(moy_red_ec ~ 
...
s13hnolinq5npchge_sB_red_dr2 <- update(s13hnolinq5npchge_sA_red_dr2, . ~ . 
...
s13hnolinq5npchge_sC_red_dr2 <- update(s13hnolinq5npchge_sB_red_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_red_dr2 <- update(s13hnolinq5npchge_sC_red_dr2, . ~ . 
...
s13hnolinq5npchge_sE_red_dr2 <- update(s13hnolinq5npchge_sD_red_dr2, . ~ . 
...
s13hnolinq5npchge_sF_red_dr2 <- update(s13hnolinq5npchge_sC_red_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_2", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_red_dr2.rda"), version = 2)