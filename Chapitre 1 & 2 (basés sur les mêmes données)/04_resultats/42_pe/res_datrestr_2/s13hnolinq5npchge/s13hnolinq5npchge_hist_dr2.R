...
s13hnolinq5npchge_sA_hist_dr2 <- plm(moy_hist_ec ~ 
...
s13hnolinq5npchge_sB_hist_dr2 <- update(s13hnolinq5npchge_sA_hist_dr2, . ~ . 
...
s13hnolinq5npchge_sC_hist_dr2 <- update(s13hnolinq5npchge_sB_hist_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_hist_dr2 <- update(s13hnolinq5npchge_sC_hist_dr2, . ~ . 
...
s13hnolinq5npchge_sE_hist_dr2 <- update(s13hnolinq5npchge_sD_hist_dr2, . ~ . 
...
s13hnolinq5npchge_sF_hist_dr2 <- update(s13hnolinq5npchge_sC_hist_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_2", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_hist_dr2.rda"), version = 2)