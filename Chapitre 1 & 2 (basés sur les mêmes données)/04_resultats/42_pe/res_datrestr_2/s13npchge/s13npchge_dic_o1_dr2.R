...
s13npchge_sA_dic_o1_dr2 <- plm(moy_dic_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_2, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13npchge_sB_dic_o1_dr2 <- update(s13npchge_sA_dic_o1_dr2, . ~ . 
...
s13npchge_sC_dic_o1_dr2 <- update(s13npchge_sB_dic_o1_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13npchge_sD_dic_o1_dr2 <- update(s13npchge_sC_dic_o1_dr2, . ~ . 
...
s13npchge_sE_dic_o1_dr2 <- update(s13npchge_sD_dic_o1_dr2, . ~ . 
...
s13npchge_sF_dic_o1_dr2 <- update(s13npchge_sC_dic_o1_dr2, . ~ . 
