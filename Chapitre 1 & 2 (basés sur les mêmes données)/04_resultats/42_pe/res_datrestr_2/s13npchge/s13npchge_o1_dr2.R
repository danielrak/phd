...
s13npchge_sA_o1_dr2 <- plm(moy_ec1 ~ 
                         pnp_score : p + pop_score : p + v_ob_tot + p, 
                       datrestr_2, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13npchge_sB_o1_dr2 <- update(s13npchge_sA_o1_dr2, . ~ . 
...
s13npchge_sC_o1_dr2 <- update(s13npchge_sB_o1_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13npchge_sD_o1_dr2 <- update(s13npchge_sC_o1_dr2, . ~ . 
...
s13npchge_sE_o1_dr2 <- update(s13npchge_sD_o1_dr2, . ~ . 
...
s13npchge_sF_o1_dr2 <- update(s13npchge_sC_o1_dr2, . ~ . 
