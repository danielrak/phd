...
s13npchge_sA_french_o1_dr2 <- plm(moy_fran_ec ~ 
                         pnp_score : p + pop_score : p + v_ob_tot + p, 
                       datrestr_2, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13npchge_sB_french_o1_dr2 <- update(s13npchge_sA_french_o1_dr2, . ~ . 
...
s13npchge_sC_french_o1_dr2 <- update(s13npchge_sB_french_o1_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13npchge_sD_french_o1_dr2 <- update(s13npchge_sC_french_o1_dr2, . ~ . 
...
s13npchge_sE_french_o1_dr2 <- update(s13npchge_sD_french_o1_dr2, . ~ . 
...
s13npchge_sF_french_o1_dr2 <- update(s13npchge_sC_french_o1_dr2, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_2", "s13npchge", 
                 "s13_french_o1_dr2.rda"), version = 2)