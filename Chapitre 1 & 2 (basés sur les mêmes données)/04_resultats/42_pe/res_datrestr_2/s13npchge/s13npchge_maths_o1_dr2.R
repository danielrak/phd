...
s13npchge_sA_maths_o1_dr2 <- plm(moy_maths_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_2, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13npchge_sB_maths_o1_dr2 <- update(s13npchge_sA_maths_o1_dr2, . ~ . 
...
s13npchge_sC_maths_o1_dr2 <- update(s13npchge_sB_maths_o1_dr2, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13npchge_sD_maths_o1_dr2 <- update(s13npchge_sC_maths_o1_dr2, . ~ . 
...
s13npchge_sE_maths_o1_dr2 <- update(s13npchge_sD_maths_o1_dr2, . ~ . 
...
s13npchge_sF_maths_o1_dr2 <- update(s13npchge_sC_maths_o1_dr2, . ~ . 
