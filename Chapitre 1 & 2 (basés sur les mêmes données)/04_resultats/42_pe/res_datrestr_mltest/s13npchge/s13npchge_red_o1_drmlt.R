...
s13npchge_sA_red_o1_drmlt <- plm(moy_red_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_mltest, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13npchge_sB_red_o1_drmlt <- update(s13npchge_sA_red_o1_drmlt, . ~ . 
...
s13npchge_sC_red_o1_drmlt <- update(s13npchge_sB_red_o1_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13npchge_sD_red_o1_drmlt <- update(s13npchge_sC_red_o1_drmlt, . ~ . 
...
s13npchge_sE_red_o1_drmlt <- update(s13npchge_sD_red_o1_drmlt, . ~ . 
...
s13npchge_sF_red_o1_drmlt <- update(s13npchge_sC_red_o1_drmlt, . ~ . 
