...
s13npchge_sA_dic_o1_drmlt <- plm(moy_dic_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_mltest, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13npchge_sB_dic_o1_drmlt <- update(s13npchge_sA_dic_o1_drmlt, . ~ . 
...
s13npchge_sC_dic_o1_drmlt <- update(s13npchge_sB_dic_o1_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13npchge_sD_dic_o1_drmlt <- update(s13npchge_sC_dic_o1_drmlt, . ~ . 
...
s13npchge_sE_dic_o1_drmlt <- update(s13npchge_sD_dic_o1_drmlt, . ~ . 
...
s13npchge_sF_dic_o1_drmlt <- update(s13npchge_sC_dic_o1_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13npchge", 
                 "s13_dic_o1_drmlt.rda"), version = 2)