# s13h5npchge_o1_maths_drmlt, moy_maths_ec. 
...
s13h5npchge_sA_maths_drmlt <- plm(moy_maths_ec ~ 
...
s13h5npchge_sB_maths_drmlt <- update(s13h5npchge_sA_maths_drmlt, . ~ . 
...
s13h5npchge_sC_maths_drmlt <- update(s13h5npchge_sB_maths_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5npchge_sD_maths_drmlt <- update(s13h5npchge_sC_maths_drmlt, . ~ . 
...
s13h5npchge_sE_maths_drmlt <- update(s13h5npchge_sD_maths_drmlt, . ~ . 
...
s13h5npchge_sF_maths_drmlt <- update(s13h5npchge_sC_maths_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13h5npchge", 
                 "s13h5npchge_maths_drmlt.rda"), version = 2)