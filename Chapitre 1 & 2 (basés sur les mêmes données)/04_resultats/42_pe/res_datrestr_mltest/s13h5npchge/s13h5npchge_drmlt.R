...
s13h5npchge_sA_drmlt <- plm(moy_ec1 ~ 
...
s13h5npchge_sB_drmlt <- update(s13h5npchge_sA_drmlt, . ~ . 
...
s13h5npchge_sC_drmlt <- update(s13h5npchge_sB_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5npchge_sD_drmlt <- update(s13h5npchge_sC_drmlt, . ~ . 
...
s13h5npchge_sE_drmlt <- update(s13h5npchge_sD_drmlt, . ~ . 
...
s13h5npchge_sF_drmlt <- update(s13h5npchge_sC_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13h5npchge", 
                 "s13h5npchge_drmlt.rda"), version = 2)