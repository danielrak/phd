# s13h5npchge_o1_red_drmlt, moy_red_ec. 
...
s13h5npchge_sA_red_drmlt <- plm(moy_red_ec ~ 
...
s13h5npchge_sB_red_drmlt <- update(s13h5npchge_sA_red_drmlt, . ~ . 
...
s13h5npchge_sC_red_drmlt <- update(s13h5npchge_sB_red_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5npchge_sD_red_drmlt <- update(s13h5npchge_sC_red_drmlt, . ~ . 
...
s13h5npchge_sE_red_drmlt <- update(s13h5npchge_sD_red_drmlt, . ~ . 
...
s13h5npchge_sF_red_drmlt <- update(s13h5npchge_sC_red_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13h5npchge", 
                 "s13h5npchge_red_drmlt.rda"), version = 2)