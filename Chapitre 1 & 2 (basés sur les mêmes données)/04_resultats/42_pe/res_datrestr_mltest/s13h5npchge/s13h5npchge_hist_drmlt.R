# s13h5npchge_o1_hist_drmlt, moy_hist_ec. 
...
s13h5npchge_sA_hist_drmlt <- plm(moy_hist_ec ~ 
...
s13h5npchge_sB_hist_drmlt <- update(s13h5npchge_sA_hist_drmlt, . ~ . 
...
s13h5npchge_sC_hist_drmlt <- update(s13h5npchge_sB_hist_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5npchge_sD_hist_drmlt <- update(s13h5npchge_sC_hist_drmlt, . ~ . 
...
s13h5npchge_sE_hist_drmlt <- update(s13h5npchge_sD_hist_drmlt, . ~ . 
...
s13h5npchge_sF_hist_drmlt <- update(s13h5npchge_sC_hist_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13h5npchge", 
                 "s13h5npchge_hist_drmlt.rda"), version = 2)