...
s13hnolinq5np_sA_drmlt <- plm(moy_ec1 ~ 
...
s13hnolinq5np_sB_drmlt <- update(s13hnolinq5np_sA_drmlt, . ~ . 
...
s13hnolinq5np_sC_drmlt <- update(s13hnolinq5np_sB_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5np_sD_drmlt <- update(s13hnolinq5np_sC_drmlt, . ~ . 
...
s13hnolinq5np_sE_drmlt <- update(s13hnolinq5np_sD_drmlt, . ~ . 
...
s13hnolinq5np_sF_drmlt <- update(s13hnolinq5np_sC_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5np",
                 "s13hnolinq5np_drmlt.rda"), version = 2)