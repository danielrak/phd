...
s13hnolinq5np_sA_french_drmlt <- plm(moy_fran_ec ~ 
...
s13hnolinq5np_sB_french_drmlt <- update(s13hnolinq5np_sA_french_drmlt, . ~ . 
...
s13hnolinq5np_sC_french_drmlt <- update(s13hnolinq5np_sB_french_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5np_sD_french_drmlt <- update(s13hnolinq5np_sC_french_drmlt, . ~ . 
...
s13hnolinq5np_sE_french_drmlt <- update(s13hnolinq5np_sD_french_drmlt, . ~ . 
...
s13hnolinq5np_sF_french_drmlt <- update(s13hnolinq5np_sC_french_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5np",
                 "s13hnolinq5np_french_drmlt.rda"), version = 2)