...
s13hnolinq5np_sA_red_drmlt <- plm(moy_red_ec ~ 
...
s13hnolinq5np_sB_red_drmlt <- update(s13hnolinq5np_sA_red_drmlt, . ~ . 
...
s13hnolinq5np_sC_red_drmlt <- update(s13hnolinq5np_sB_red_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5np_sD_red_drmlt <- update(s13hnolinq5np_sC_red_drmlt, . ~ . 
...
s13hnolinq5np_sE_red_drmlt <- update(s13hnolinq5np_sD_red_drmlt, . ~ . 
...
s13hnolinq5np_sF_red_drmlt <- update(s13hnolinq5np_sC_red_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5np",
                 "s13hnolinq5np_red_drmlt.rda"), version = 2)