...
s13hnolinq5np_sA_maths_drmlt <- plm(moy_maths_ec ~ 
...
s13hnolinq5np_sB_maths_drmlt <- update(s13hnolinq5np_sA_maths_drmlt, . ~ . 
...
s13hnolinq5np_sC_maths_drmlt <- update(s13hnolinq5np_sB_maths_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5np_sD_maths_drmlt <- update(s13hnolinq5np_sC_maths_drmlt, . ~ . 
...
s13hnolinq5np_sE_maths_drmlt <- update(s13hnolinq5np_sD_maths_drmlt, . ~ . 
...
s13hnolinq5np_sF_maths_drmlt <- update(s13hnolinq5np_sC_maths_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5np",
                 "s13hnolinq5np_maths_drmlt.rda"), version = 2)