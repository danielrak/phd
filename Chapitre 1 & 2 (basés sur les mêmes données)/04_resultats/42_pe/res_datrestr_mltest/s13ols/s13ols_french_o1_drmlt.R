...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13ols", 
                 "s13ols_french_o1_drmlt.rda"), version = 2)