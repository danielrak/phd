# s13h5np_o1_maths_drmlt, moy_maths_ec. 
...
s13h5np_sA_maths_drmlt <- plm(moy_maths_ec ~ 
...
s13h5np_sB_maths_drmlt <- update(s13h5np_sA_maths_drmlt, . ~ . 
...
s13h5np_sC_maths_drmlt <- update(s13h5np_sB_maths_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_maths_drmlt <- update(s13h5np_sC_maths_drmlt, . ~ . 
...
s13h5np_sE_maths_drmlt <- update(s13h5np_sD_maths_drmlt, . ~ . 
...
s13h5np_sF_maths_drmlt <- update(s13h5np_sC_maths_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13h5np", 
                 "s13h5np_maths_drmlt.rda"), version = 2)