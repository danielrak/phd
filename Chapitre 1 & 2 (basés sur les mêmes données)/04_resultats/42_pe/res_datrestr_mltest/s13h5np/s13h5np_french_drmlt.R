# s13h5np_o1_french_drmlt, moy_fran_ec. 
...
s13h5np_sA_french_drmlt <- plm(moy_fran_ec ~ 
...
s13h5np_sB_french_drmlt <- update(s13h5np_sA_french_drmlt, . ~ . 
...
s13h5np_sC_french_drmlt <- update(s13h5np_sB_french_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_french_drmlt <- update(s13h5np_sC_french_drmlt, . ~ . 
...
s13h5np_sE_french_drmlt <- update(s13h5np_sD_french_drmlt, . ~ . 
...
s13h5np_sF_french_drmlt <- update(s13h5np_sC_french_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13h5np", 
                 "s13h5np_french_drmlt.rda"), version = 2)