# s13h5np_o1_dic_drmlt, moy_dic_ec. 
...
s13h5np_sA_dic_drmlt <- plm(moy_dic_ec ~ 
...
s13h5np_sB_dic_drmlt <- update(s13h5np_sA_dic_drmlt, . ~ . 
...
s13h5np_sC_dic_drmlt <- update(s13h5np_sB_dic_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_dic_drmlt <- update(s13h5np_sC_dic_drmlt, . ~ . 
...
s13h5np_sE_dic_drmlt <- update(s13h5np_sD_dic_drmlt, . ~ . 
...
s13h5np_sF_dic_drmlt <- update(s13h5np_sC_dic_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13h5np", 
                 "s13h5np_dic_drmlt.rda"), version = 2)