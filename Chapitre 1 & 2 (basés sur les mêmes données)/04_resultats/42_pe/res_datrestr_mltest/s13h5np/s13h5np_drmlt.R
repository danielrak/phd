...
s13h5np_sB_drmlt <- update(s13h5np_sA_drmlt, . ~ . 
...
s13h5np_sC_drmlt <- update(s13h5np_sB_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13h5np_sD_drmlt <- update(s13h5np_sC_drmlt, . ~ . 
...
s13h5np_sE_drmlt <- update(s13h5np_sD_drmlt, . ~ . 
...
s13h5np_sF_drmlt <- update(s13h5np_sC_drmlt, . ~ . 
