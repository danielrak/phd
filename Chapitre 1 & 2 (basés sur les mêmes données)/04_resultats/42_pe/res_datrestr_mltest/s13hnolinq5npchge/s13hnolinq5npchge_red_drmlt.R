# s13hnolinq5npchge, dr2, moy_red_ec
...
s13hnolinq5npchge_sA_red_drmlt <- plm(moy_red_ec ~ 
...
s13hnolinq5npchge_sB_red_drmlt <- update(s13hnolinq5npchge_sA_red_drmlt, . ~ . 
...
s13hnolinq5npchge_sC_red_drmlt <- update(s13hnolinq5npchge_sB_red_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_red_drmlt <- update(s13hnolinq5npchge_sC_red_drmlt, . ~ . 
...
s13hnolinq5npchge_sE_red_drmlt <- update(s13hnolinq5npchge_sD_red_drmlt, . ~ . 
...
s13hnolinq5npchge_sF_red_drmlt <- update(s13hnolinq5npchge_sC_red_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_red_drmlt.rda"), version = 2)