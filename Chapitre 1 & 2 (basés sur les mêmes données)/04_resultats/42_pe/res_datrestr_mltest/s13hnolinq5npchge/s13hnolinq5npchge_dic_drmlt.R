...
s13hnolinq5npchge_sA_dic_drmlt <- plm(moy_dic_ec ~ 
...
s13hnolinq5npchge_sB_dic_drmlt <- update(s13hnolinq5npchge_sA_dic_drmlt, . ~ . 
...
s13hnolinq5npchge_sC_dic_drmlt <- update(s13hnolinq5npchge_sB_dic_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_dic_drmlt <- update(s13hnolinq5npchge_sC_dic_drmlt, . ~ . 
...
s13hnolinq5npchge_sE_dic_drmlt <- update(s13hnolinq5npchge_sD_dic_drmlt, . ~ . 
...
s13hnolinq5npchge_sF_dic_drmlt <- update(s13hnolinq5npchge_sC_dic_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_dic_drmlt.rda"), version = 2)