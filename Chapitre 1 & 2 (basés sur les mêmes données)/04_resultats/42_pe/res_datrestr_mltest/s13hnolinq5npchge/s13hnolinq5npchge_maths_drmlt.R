# s13hnolinq5npchge, dr2, moy_maths_ec
...
s13hnolinq5npchge_sA_maths_drmlt <- plm(moy_maths_ec ~ 
...
s13hnolinq5npchge_sB_maths_drmlt <- update(s13hnolinq5npchge_sA_maths_drmlt, . ~ . 
...
s13hnolinq5npchge_sC_maths_drmlt <- update(s13hnolinq5npchge_sB_maths_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_maths_drmlt <- update(s13hnolinq5npchge_sC_maths_drmlt, . ~ . 
...
s13hnolinq5npchge_sE_maths_drmlt <- update(s13hnolinq5npchge_sD_maths_drmlt, . ~ . 
...
s13hnolinq5npchge_sF_maths_drmlt <- update(s13hnolinq5npchge_sC_maths_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_maths_drmlt.rda"), version = 2)