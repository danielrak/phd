# s13hnolinq5npchge, dr2, moy_fran_ec
...
s13hnolinq5npchge_sA_french_drmlt <- plm(moy_fran_ec ~ 
...
s13hnolinq5npchge_sB_french_drmlt <- update(s13hnolinq5npchge_sA_french_drmlt, . ~ . 
...
s13hnolinq5npchge_sC_french_drmlt <- update(s13hnolinq5npchge_sB_french_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_french_drmlt <- update(s13hnolinq5npchge_sC_french_drmlt, . ~ . 
...
s13hnolinq5npchge_sE_french_drmlt <- update(s13hnolinq5npchge_sD_french_drmlt, . ~ . 
...
s13hnolinq5npchge_sF_french_drmlt <- update(s13hnolinq5npchge_sC_french_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_french_drmlt.rda"), version = 2)