...
s13hnolinq5npchge_sA_drmlt <- plm(moy_ec1 ~ 
...
s13hnolinq5npchge_sB_drmlt <- update(s13hnolinq5npchge_sA_drmlt, . ~ . 
...
s13hnolinq5npchge_sC_drmlt <- update(s13hnolinq5npchge_sB_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13hnolinq5npchge_sD_drmlt <- update(s13hnolinq5npchge_sC_drmlt, . ~ . 
...
s13hnolinq5npchge_sE_drmlt <- update(s13hnolinq5npchge_sD_drmlt, . ~ . 
...
s13hnolinq5npchge_sF_drmlt <- update(s13hnolinq5npchge_sC_drmlt, . ~ . 
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.")], 
     file = here("res_datrestr_mltest", "s13hnolinq5npchge",
                 "s13hnolinq5npchge_drmlt.rda"), version = 2)