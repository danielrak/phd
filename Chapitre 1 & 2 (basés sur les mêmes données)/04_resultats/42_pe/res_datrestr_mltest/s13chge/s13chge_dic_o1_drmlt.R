...
sB <- c(sA, "sexe_mod_M",
        ...
        "age_absdnb", 
        "positiondnb2_Heure", "positiondnb2_Avance", "chge")
...
save(list = ls()[str_detect(ls(), "^ct\\.|^n\\.|^arsq\\.|^mvc\\.")], 
     file = here("res_datrestr_mltest", "s13chge", 
                 "s13chge_dic_o1_drmlt.rda"), version = 2)