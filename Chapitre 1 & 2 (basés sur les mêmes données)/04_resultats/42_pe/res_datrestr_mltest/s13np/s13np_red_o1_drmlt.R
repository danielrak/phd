...
s13np_sA_red_o1_drmlt <- plm(moy_red_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_mltest, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13np_sB_red_o1_drmlt <- update(s13np_sA_red_o1_drmlt, . ~ . 
...
s13np_sC_red_o1_drmlt <- update(s13np_sB_red_o1_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13np_sD_red_o1_drmlt <- update(s13np_sC_red_o1_drmlt, . ~ . 
...
s13np_sE_red_o1_drmlt <- update(s13np_sD_red_o1_drmlt, . ~ . 
...
s13np_sF_red_o1_drmlt <- update(s13np_sC_red_o1_drmlt, . ~ . 
