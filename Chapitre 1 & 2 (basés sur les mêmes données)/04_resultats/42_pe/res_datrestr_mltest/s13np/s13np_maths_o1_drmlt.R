...
s13np_sA_maths_o1_drmlt <- plm(moy_maths_ec ~ 
                                pnp_score : p + pop_score : p + v_ob_tot + p, 
                              datrestr_mltest, subset = obs == 1, index = "rneconstatses")

# sB ----------------------------------------------------------------------

s13np_sB_maths_o1_drmlt <- update(s13np_sA_maths_o1_drmlt, . ~ . 
...
s13np_sC_maths_o1_drmlt <- update(s13np_sB_maths_o1_drmlt, . ~ . + tdivconstatrneses)

# sD ----------------------------------------------------------------------

s13np_sD_maths_o1_drmlt <- update(s13np_sC_maths_o1_drmlt, . ~ . 
...
s13np_sE_maths_o1_drmlt <- update(s13np_sD_maths_o1_drmlt, . ~ . 
...
s13np_sF_maths_o1_drmlt <- update(s13np_sC_maths_o1_drmlt, . ~ . 
